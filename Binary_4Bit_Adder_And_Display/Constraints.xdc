...
set_property PACKAGE_PIN T1 [get_ports {display_choice[0]}]
set_property PACKAGE_PIN R2 [get_ports {display_choice[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a b d o AN display_choice}]